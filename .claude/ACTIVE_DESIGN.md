...
> Last updated: 2026-09-22（コンテナ形式の波 段0完了 — ADR 0108 / container-v1 はacceptedで段1〈IR v2 + リーダ + writer / 移行CLI〉に着手。backlogの消化済み12節は[退避スナップショット](../docs/research/2026-09-22-backlog-archive-0.5.0-to-0.12.0.md)へ移し、backlogは運用契約どおり未消化項目だけになった）
