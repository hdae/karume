...
- **9/11 レビュー対応後の再開** — [調査・実測と引き継ぎ](../docs/research/2026-09-10-codex-mtp-optimization.md#分割コミットと再開用の引き継ぎ) を先に読む。
  ...
  Chrome E2B/E4Bで効果、Deno E2Bはほぼ中立。改善後M2も利用者追試で速度向上・40生成の一致を確認。H-23は[chunk64の比較画面とキャッシュ負荷検証](../docs/research/2026-09-13-prefill-buckets.md)を追加。全chunkへの細分化は見送り、次はM2。QATのM2/RTX生成列には導入前から差があり、別途帰属する。
