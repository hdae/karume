// karume attention_pv (O[b,m,d] = P[b,m,n] · v[b,n,d], P̃ = round(127·exp(S − m)) は非実体化, v は per-column i8（Vᵀ 連続）, 行窓 c, タイル 64x128 / 1 スレッド 8x8 / wg 16x8 / K 16 + vec4)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
...
fn main(
  ...
  let obase = wid.z * dims.rows_full * n4 + dims.row_offset * n4;
