// karume conv1d (x[B,Cin,L] * W[Cout,Cin,K] + b[Cout], f32, 重み i4 格納, implicit GEMM レジスタ 32x128 タイル / 1 スレッド 8x8 / wg 16x4 + vec4)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
...
fn main(
  ...
  for (var t = 0u; t < tiles; t = t + 1u) {
    ...
    if (arow0 < dims.m && ak0 < dims.k) {
      ...
      av0 = dequant4(arow_base0 + ak0, ags0);
    }
    sa[sa_base0] = av0.x;
    ...
    if (arow1 < dims.m && ak0 < dims.k) {
      ...
      av1 = dequant4(arow_base1 + ak0, ags1);
    }
    sa[sa_base1] = av1.x;
