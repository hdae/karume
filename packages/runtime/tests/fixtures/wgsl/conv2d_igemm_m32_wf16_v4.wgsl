// karume conv2d (x[B,Cin,H,W] * W[Cout,Cin,Kh,Kw] + b[Cout], f32, 重み f16 格納, implicit GEMM レジスタ 32x128 タイル / 1 スレッド 8x8 / wg 16x4 + vec4)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
