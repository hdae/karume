...
fn main(
  ...
  for (var t = 0u; t < tiles; t = t + 1u) {
    ...
    if (arow0 < dims.m) {
      ...
      if (ak0 + 1u < dims.k) {
        av0.y = exp(f32(s[arow_base0 + ak0 + 1u]) - row_max0) * row_inv0;
      }
      if (ak0 + 2u < dims.k) {
        av0.z = exp(f32(s[arow_base0 + ak0 + 2u]) - row_max0) * row_inv0;
      }
      if (ak0 + 3u < dims.k) {
        av0.w = exp(f32(s[arow_base0 + ak0 + 3u]) - row_max0) * row_inv0;
      }
    }
    ...
    if (arow1 < dims.m) {
      if (ak0 < dims.k) {
        av1.x = exp(f32(s[arow_base1 + ak0]) - row_max1) * row_inv1;
      }
      if (ak0 + 1u < dims.k) {
        av1.y = exp(f32(s[arow_base1 + ak0 + 1u]) - row_max1) * row_inv1;
      }
      if (ak0 + 2u < dims.k) {
        av1.z = exp(f32(s[arow_base1 + ak0 + 2u]) - row_max1) * row_inv1;
      }
      if (ak0 + 3u < dims.k) {
        av1.w = exp(f32(s[arow_base1 + ak0 + 3u]) - row_max1) * row_inv1;
      }
    }
