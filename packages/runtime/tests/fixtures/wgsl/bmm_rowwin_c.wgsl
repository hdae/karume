// karume bmm (a[b,m,k] · b[b,k,n], f32, 行窓 c, レジスタ 128x128 タイル / 1 スレッド 8x8 / wg 16x16)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
...
fn main(
  ...
  let cbase = wid.z * dims.rows_full * dims.n + dims.row_offset * dims.n;
  ...
  for (var t = 0u; t < tiles; t = t + 1u) {
    ...
    if (arow0 < dims.m) {
      if (ak0 < dims.k) {
        av0.x = a[arow_base0 + ak0];
      }
      if (ak0 + 1u < dims.k) {
        av0.y = a[arow_base0 + ak0 + 1u];
      }
      if (ak0 + 2u < dims.k) {
        av0.z = a[arow_base0 + ak0 + 2u];
      }
      if (ak0 + 3u < dims.k) {
        av0.w = a[arow_base0 + ak0 + 3u];
      }
    }
    sa[sa_base0] = av0.x;
    ...
    if (arow1 < dims.m) {
      if (ak0 < dims.k) {
        av1.x = a[arow_base1 + ak0];
      }
      if (ak0 + 1u < dims.k) {
        av1.y = a[arow_base1 + ak0 + 1u];
      }
      if (ak0 + 2u < dims.k) {
        av1.z = a[arow_base1 + ak0 + 2u];
      }
      if (ak0 + 3u < dims.k) {
        av1.w = a[arow_base1 + ak0 + 3u];
      }
    }
    sa[sa_base1] = av1.x;
    ...
    if (brow0 < dims.k) {
      ...
      if (bcol < dims.n) {
        bv4_0.x = b[brow_base + bcol];
      }
      if (bcol + 1u < dims.n) {
        bv4_0.y = b[brow_base + bcol + 1u];
      }
      if (bcol + 2u < dims.n) {
        bv4_0.z = b[brow_base + bcol + 2u];
      }
      if (bcol + 3u < dims.n) {
    ...
    if (brow1 < dims.k) {
      ...
      if (bcol < dims.n) {
        bv4_1.x = b[brow_base + bcol];
      }
      if (bcol + 1u < dims.n) {
        bv4_1.y = b[brow_base + bcol + 1u];
      }
      if (bcol + 2u < dims.n) {
        bv4_1.z = b[brow_base + bcol + 2u];
      }
      if (bcol + 3u < dims.n) {
  ...
  if (orow0 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc0_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc0_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc0_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow1 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc1_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc1_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc1_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow2 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc2_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc2_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc2_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow3 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc3_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc3_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc3_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow4 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc4_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc4_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc4_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow5 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc5_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc5_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc5_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow6 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc6_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc6_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc6_0.z;
    }
    if (ocol + 3u < dims.n) {
  ...
  if (orow7 < dims.m) {
    ...
    if (ocol < dims.n) {
      c[obase + ocol] = acc7_0.x;
    }
    if (ocol + 1u < dims.n) {
      c[obase + ocol + 1u] = acc7_0.y;
    }
    if (ocol + 2u < dims.n) {
      c[obase + ocol + 2u] = acc7_0.z;
    }
    if (ocol + 3u < dims.n) {
