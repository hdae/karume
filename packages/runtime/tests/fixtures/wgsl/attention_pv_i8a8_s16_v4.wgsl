// karume attention_pv (O[b,m,d] = P[b,m,n] · v[b,n,d], P̃ = round(127·exp(S − m)) は非実体化, v は per-column i8（Vᵀ 連続）, S は f16 格納（pack2x16float）, タイル 64x128 / 1 スレッド 8x8 / wg 16x8 / K 16 + vec4)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
