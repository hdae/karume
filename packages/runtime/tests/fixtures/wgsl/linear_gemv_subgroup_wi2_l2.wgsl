...
// karume linear gemv K subgroup32 (i2, 2 lanes/output)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
...
fn main(
  ...
  let lane = sub % 2u;
  let col = wg.x * 64u + sg * 16u + sub / 2u;
  var acc = 0.0;
  ...
  let wscale_v = wscale[col];
    ...
    acc = fma(xt_10_0.x, dt_10.x, acc);
    acc = fma(xt_10_0.y, dt_10.y, acc);
    acc = fma(xt_10_0.z, dt_10.z, acc);
    acc = fma(xt_10_0.w, dt_10.w, acc);
    ...
    acc = fma(xt_11_0.x, dt_11.x, acc);
    acc = fma(xt_11_0.y, dt_11.y, acc);
    acc = fma(xt_11_0.z, dt_11.z, acc);
    acc = fma(xt_11_0.w, dt_11.w, acc);
    ...
    acc = fma(xt_12_0.x, dt_12.x, acc);
    acc = fma(xt_12_0.y, dt_12.y, acc);
    acc = fma(xt_12_0.z, dt_12.z, acc);
    acc = fma(xt_12_0.w, dt_12.w, acc);
    ...
    acc = fma(xt_13_0.x, dt_13.x, acc);
    acc = fma(xt_13_0.y, dt_13.y, acc);
    acc = fma(xt_13_0.z, dt_13.z, acc);
    acc = fma(xt_13_0.w, dt_13.w, acc);
    ...
    acc = fma(xt_14_0.x, dt_14.x, acc);
    acc = fma(xt_14_0.y, dt_14.y, acc);
    acc = fma(xt_14_0.z, dt_14.z, acc);
    acc = fma(xt_14_0.w, dt_14.w, acc);
    ...
    acc = fma(xt_15_0.x, dt_15.x, acc);
    acc = fma(xt_15_0.y, dt_15.y, acc);
    acc = fma(xt_15_0.z, dt_15.z, acc);
    acc = fma(xt_15_0.w, dt_15.w, acc);
    }
  }
