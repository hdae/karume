// karume attention_qk (S[b,m,n] = q[b,m,d] · k[b,n,d]ᵀ, q/k とも per-token i8 の整数内積, 半スケールは dequant 側, S は f16 格納（pack2x16float）, タイル 128x64 / 1 スレッド 8x8 / wg 8x16 / K 16 + vec4)
struct Dims {
  m: u32,
  n: u32,
  k: u32,
