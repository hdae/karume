...
fn main(@builtin(local_invocation_index) lid: u32, @builtin(workgroup_id) wg: vec3<u32>) {
  ...
  let wscale_v = wscale[col];
    ...
    let xpt_0 = x[xqt + 0u];
    let xt_0_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_0.x)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_1_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_0.y)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_2_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_0.z)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_3_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_0.w)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xpt_1 = x[xqt + 1u];
    let xt_4_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_1.x)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_5_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_1.y)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_6_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_1.z)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_7_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_1.w)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xpt_2 = x[xqt + 2u];
    let xt_8_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_2.x)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_9_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_2.y)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_10_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_2.z)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_11_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_2.w)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xpt_3 = x[xqt + 3u];
    let xt_12_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_3.x)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_13_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_3.y)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_14_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_3.z)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
    ...
    let xt_15_0 = bitcast<vec4<f32>>(bitcast<vec4<u32>>(vec4<f32>(unpack4xI8(xpt_3.w)) * dims.x_scale) ^ vec4<u32>(dims.rounding_mask));
