...
テキストではなく画像で持つ。
    ...
    cd tools/exporter
    uv run --group siglip2-preprocess python siglip2_preprocess.py
...
from export_siglip2 import DEFAULT_MODEL_DIR, MODELS_ROOT
...
def build_fixture(processor: Any, models_root: Path) -> dict[str, Any]:
    ...
    return {
        "_doc": [
            ...
            "（生成: tools/exporter/siglip2_preprocess.py）。",
