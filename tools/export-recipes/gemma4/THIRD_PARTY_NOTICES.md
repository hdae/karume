...
`models/karume-gemma4-e2b`). The verbatim Apache 2.0 text is vendored here as
`apache_license_2_0.txt` and shipped as the distribution's `LICENSE.md`, alongside a `NOTICE.md`
that lists the modifications required by Apache 2.0 §4(b).
