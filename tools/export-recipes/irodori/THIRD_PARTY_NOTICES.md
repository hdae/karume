...
| Weights license          | n/a                                                                                                                                                                                                                                                              |
| Attribution requirements | `patch.py` carries the upstream copyright notice ("Copyright (c) 2026 Aratako") and the MIT License reference in a comment block directly above `_folded_rms_low_rank_adaln_forward` (decided 2026-09-25). No upstream source enters the published distribution. |
...
| Weights license          | n/a                                                                                                                                                                                                                                                                                                                     |
| Attribution requirements | `patch.py` carries the upstream copyright notice (verbatim from the header of `modeling_modernbert.py`), the Apache 2.0 license reference and a statement of the change in a comment block directly above `_flat_qkv_attention_forward` (decided 2026-09-25). No `transformers` code enters the published distribution. |
