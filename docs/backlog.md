...
大所 = **gemma4 decode の GEMV 並列度**（2026-09-06 ユーザー裁定の a 案）: K-16 / K-14 は済（perf-ledger ✅）・次は K-13（下の 1）。
波と独立に消化してよい残件はその下。

1. **c. perf K-13**（prefill attention の K/V タイル再利用 — K-14 は 2026-09-06 に済）:
